...
[assembly: RegisterDocumentType(PageType_PatientEducation.CLASS_NAME, typeof(PageType_PatientEducation))]

namespace Njh.Kernel.Kentico.Models.PageTypes
{
    /// <summary>
    /// Represents a content item of type PageType_PatientEducation.
    /// </summary>
    public partial class PageType_PatientEducation : TreeNode
    {
        ...
        /// </summary>
        public const string CLASS_NAME = "NJH.PageType_PatientEducation";


        /// <summary>
        /// The instance of the class that provides extended API for working with PageType_PatientEducation fields.
        /// </summary>
        private readonly PageType_PatientEducationFields mFields;
        ...
        /// </summary>
        [DatabaseIDField]
        public int PatientEducationID
        {
            get
            {
                return ValidationHelper.GetInteger(GetValue("PatientEducationID"), 0);
            }
            set
            {
                SetValue("PatientEducationID", value);
            }
        }
        ...
        public string Fees
        {
            get
            {
                return ValidationHelper.GetString(GetValue("Fees"), @"");
            }
            set
            {
                SetValue("Fees", value);
        ...
        public string Date_Info
        {
            get
            {
                return ValidationHelper.GetString(GetValue("Date_Info"), @"");
            }
            set
            {
                SetValue("Date_Info", value);
            }
        }
        ...
        public string Class_Days
        {
            get
            {
                return ValidationHelper.GetString(GetValue("Class_Days"), @"");
            }
            set
            {
                SetValue("Class_Days", value);
            }
        }
        ...
        /// <summary>
        /// Gets an object that provides extended API for working with PageType_PatientEducation fields.
        /// </summary>
        [RegisterProperty]
        public PageType_PatientEducationFields Fields
        {
            get
            {
                return mFields;
        ...
        /// <summary>
        /// Provides extended API for working with PageType_PatientEducation fields.
        /// </summary>
        [RegisterAllProperties]
        public partial class PageType_PatientEducationFields : AbstractHierarchicalObject<PageType_PatientEducationFields>
        {
            /// <summary>
            /// The content item of type PageType_PatientEducation that is a target of the extended API.
            /// </summary>
            private readonly PageType_PatientEducation mInstance;


            /// <summary>
            /// Initializes a new instance of the <see cref="PageType_PatientEducationFields" /> class with the specified content item of type PageType_PatientEducation.
            /// </summary>
            /// <param name="instance">The content item of type PageType_PatientEducation that is a target of the extended API.</param>
            public PageType_PatientEducationFields(PageType_PatientEducation instance)
            {
                mInstance = instance;
            }
            ...
            public int PatientEducationID
            {
                get
                {
                    return mInstance.PatientEducationID;
                }
                set
                {
                    mInstance.PatientEducationID = value;
                }
            }
            ...
            public string Fees
            {
                get
                {
                    return mInstance.Fees;
                }
                set
                {
                    mInstance.Fees = value;
                }
            }
            ...
            public string Date_Info
            {
                get
                {
                    return mInstance.Date_Info;
                }
                set
                {
                    mInstance.Date_Info = value;
                }
            }
            ...
            public string Class_Days
            {
                get
                {
                    return mInstance.Class_Days;
                }
                set
                {
                    mInstance.Class_Days = value;
                }
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageType_PatientEducation" /> class.
        /// </summary>
        public PageType_PatientEducation() : base(CLASS_NAME)
        {
            mFields = new PageType_PatientEducationFields(this);
        }
