...
[assembly: RegisterDocumentType(PageType_PressRelease.CLASS_NAME, typeof(PageType_PressRelease))]

namespace Njh.Kernel.Kentico.Models.PageTypes
{
    /// <summary>
    /// Represents a content item of type PageType_PressRelease.
    /// </summary>
    public partial class PageType_PressRelease : TreeNode
    {
        ...
        /// </summary>
        public const string CLASS_NAME = "NJH.PageType_PressRelease";


        /// <summary>
        /// The instance of the class that provides extended API for working with PageType_PressRelease fields.
        /// </summary>
        private readonly PageType_PressReleaseFields mFields;
        ...
        /// </summary>
        [DatabaseIDField]
        public int PageType_PressReleaseID
        {
            get
            {
                return ValidationHelper.GetInteger(GetValue("PageType_PressReleaseID"), 0);
            }
            set
            {
                SetValue("PageType_PressReleaseID", value);
            }
        }
        ...
        public DateTime PressReleaseDate
        {
            get
            {
                return ValidationHelper.GetDateTime(GetValue("PressReleaseDate"), DateTimeHelper.ZERO_TIME);
            }
            set
            {
                SetValue("PressReleaseDate", value);
            }
        }
        ...
        /// <summary>
        /// Gets an object that provides extended API for working with PageType_PressRelease fields.
        /// </summary>
        [RegisterProperty]
        public PageType_PressReleaseFields Fields
        {
            get
            {
                return mFields;
        ...
        /// <summary>
        /// Provides extended API for working with PageType_PressRelease fields.
        /// </summary>
        [RegisterAllProperties]
        public partial class PageType_PressReleaseFields : AbstractHierarchicalObject<PageType_PressReleaseFields>
        {
            /// <summary>
            /// The content item of type PageType_PressRelease that is a target of the extended API.
            /// </summary>
            private readonly PageType_PressRelease mInstance;


            /// <summary>
            /// Initializes a new instance of the <see cref="PageType_PressReleaseFields" /> class with the specified content item of type PageType_PressRelease.
            /// </summary>
            /// <param name="instance">The content item of type PageType_PressRelease that is a target of the extended API.</param>
            public PageType_PressReleaseFields(PageType_PressRelease instance)
            {
                mInstance = instance;
            }
            ...
            public int ID
            {
                get
                {
                    return mInstance.PageType_PressReleaseID;
                }
                set
                {
                    mInstance.PageType_PressReleaseID = value;
                }
            }
            ...
            public DateTime PressReleaseDate
            {
                get
                {
                    return mInstance.PressReleaseDate;
                }
                set
                {
                    mInstance.PressReleaseDate = value;
                }
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageType_PressRelease" /> class.
        /// </summary>
        public PageType_PressRelease() : base(CLASS_NAME)
        {
            mFields = new PageType_PressReleaseFields(this);
        }
