...
[assembly: RegisterDocumentType(PageType_Service.CLASS_NAME, typeof(PageType_Service))]

namespace Njh.Kernel.Kentico.Models.PageTypes
{
    /// <summary>
    /// Represents a content item of type PageType_Service.
    /// </summary>
    public partial class PageType_Service : TreeNode
    {
        ...
        /// </summary>
        public const string CLASS_NAME = "NJH.PageType_Service";


        /// <summary>
        /// The instance of the class that provides extended API for working with PageType_Service fields.
        /// </summary>
        private readonly PageType_ServiceFields mFields;
        ...
        /// </summary>
        [DatabaseIDField]
        public int PageType_ServiceID
        {
            get
            {
                return ValidationHelper.GetInteger(GetValue("PageType_ServiceID"), 0);
            }
            set
            {
                SetValue("PageType_ServiceID", value);
            }
        }
        ...
        /// <summary>
        /// Gets an object that provides extended API for working with PageType_Service fields.
        /// </summary>
        [RegisterProperty]
        public PageType_ServiceFields Fields
        {
            get
            {
                return mFields;
        ...
        /// <summary>
        /// Provides extended API for working with PageType_Service fields.
        /// </summary>
        [RegisterAllProperties]
        public partial class PageType_ServiceFields : AbstractHierarchicalObject<PageType_ServiceFields>
        {
            /// <summary>
            /// The content item of type PageType_Service that is a target of the extended API.
            /// </summary>
            private readonly PageType_Service mInstance;


            /// <summary>
            /// Initializes a new instance of the <see cref="PageType_ServiceFields" /> class with the specified content item of type PageType_Service.
            /// </summary>
            /// <param name="instance">The content item of type PageType_Service that is a target of the extended API.</param>
            public PageType_ServiceFields(PageType_Service instance)
            {
                mInstance = instance;
            }
            ...
            public int ID
            {
                get
                {
                    return mInstance.PageType_ServiceID;
                }
                set
                {
                    mInstance.PageType_ServiceID = value;
                }
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageType_Service" /> class.
        /// </summary>
        public PageType_Service() : base(CLASS_NAME)
        {
            mFields = new PageType_ServiceFields(this);
        }
