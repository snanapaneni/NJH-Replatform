namespace Njh.Mvc.Components
{
    ...
    {
        /// <summary>
        /// Gets or sets the image source from media file selection.
        /// </summary>
        [EditingComponent(MediaFilesSelector.IDENTIFIER, Order = 1, Label = "Select an Image")]
        //[EditingComponentProperty(nameof(MediaFilesSelectorProperties.DefaultValue), "")]
        ...
        /// </summary>
        [EditingComponent(TextInputComponent.IDENTIFIER, Order = 5, Label = "Image link URL", ExplanationText = "Optional image link; max 255 chars")]
        [EditingComponentProperty(nameof(TextInputProperties.DefaultValue), "")]
        [EditingComponentProperty(nameof(TextInputProperties.Size), 255)]
